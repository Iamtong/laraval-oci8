...
class OracleBuilder extends Builder
{
    ...
    {
        /** @var \Iamtong\Oci8\Query\Grammars\OracleGrammar $grammar */
        ...
        /** @var \Iamtong\Oci8\Query\Processors\OracleProcessor $processor */
     ...
     * @param  bool $not
     * @return \Illuminate\Database\Query\Builder|\Iamtong\Oci8\Query\OracleBuilder
     */
     ...
     * @param string $type
     * @param false $where
     * @return Builder|OracleBuilder
     */
    public function joinSub($query, $as, $first, $operator = null, $second = null, $type = 'inner', $where = false)
    {
        [$query, $bindings] = $this->createSub($query);

        $expression = '('.$query.') '.$this->grammar->wrap($as);
