...
use Iamtong\Oci8\Pdo\Oci8\Statement;
use Iamtong\Oci8\Schema\Trigger;
use Iamtong\Oci8\Schema\Sequence;
use Illuminate\Database\Grammar;
use Illuminate\Database\Connection;
use Doctrine\DBAL\Connection as DoctrineConnection;
use Iamtong\Oci8\Query\OracleBuilder as QueryBuilder;
use Iamtong\Oci8\Schema\OracleBuilder as SchemaBuilder;
use Doctrine\DBAL\Driver\OCI8\Driver as DoctrineDriver;
use Iamtong\Oci8\Query\Grammars\OracleGrammar as QueryGrammar;
use Iamtong\Oci8\Query\Processors\OracleProcessor as Processor;
use Iamtong\Oci8\Schema\Grammars\OracleGrammar as SchemaGrammar;
...
class Oci8Connection extends Connection
{
    ...
    /**
     * @var \Iamtong\Oci8\Schema\Sequence
     */
    protected $sequence;

    /**
     * @var \Iamtong\Oci8\Schema\Trigger
     */
    protected $trigger;
     ...
     * Get sequence class.
     *
     * @return \Iamtong\Oci8\Schema\Sequence
     */
     ...
     * Set sequence class.
     *
     * @param \Iamtong\Oci8\Schema\Sequence $sequence
     * @return \Iamtong\Oci8\Schema\Sequence
     */
     ...
     *
     * @return \Iamtong\Oci8\Schema\Trigger
     */
     ...
     *
     * @param \Iamtong\Oci8\Schema\Trigger $trigger
     * @return \Iamtong\Oci8\Schema\Trigger
     */
     ...
     *
     * @return \Iamtong\Oci8\Schema\OracleBuilder
     */
     ...
     *
     * @param string $table
     * @return \Iamtong\Oci8\Query\OracleBuilder
     */
     ...
     *
     * @return \Illuminate\Database\Grammar|\Iamtong\Oci8\Query\Grammars\OracleGrammar
     */
     ...
     *
     * @param \Illuminate\Database\Grammar|\Iamtong\Oci8\Query\Grammars\OracleGrammar|\Iamtong\Oci8\Schema\Grammars\OracleGrammar $grammar
     ...
     *
     * @return \Illuminate\Database\Grammar|\Iamtong\Oci8\Schema\Grammars\OracleGrammar
     */
     ...
     *
     * @return \Iamtong\Oci8\Query\Processors\OracleProcessor
     */
